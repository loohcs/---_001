//
//  AKSpecimenRecordContentViewController.h
//  农化通
//
...
@interface AKSpecimenRecordContentViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,currentQueryDelegate,currentRefreshDelegate,IndentReportDelegate>
{
