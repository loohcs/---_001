//
//  AKPhotoRecordContentViewController.m
//  农化通
//
...
@interface AKPhotoRecordContentViewController ()
...
@implementation AKPhotoRecordContentViewController
...
- (void)addQueryView
{
    ...
    UILabel *topLabel = [AKFastLabel labelWithFrame:CGRectMake(50, 0, 280, 44) andText:@"拍照查询：" andtextAlignment:UITextAlignmentLeft andFont:22];
    topLabel.textColor = [UIColor whiteColor];
    UILabel *queryLabel1 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 50, _FOUR_WIDTH_, _LINE_HEIGHT_) andText:@" 业 务 员：" andtextAlignment:UITextAlignmentLeft andFont:_QUERY_LABEL_FONT_];
...
- (void)viewDidLoad
{
    ...
    UILabel *topItemLabel = [AKFastLabel labelWithFrame:CGRectMake(0, 0, 180, 30) andText:@"拍照记录" andtextAlignment:UITextAlignmentCenter andFont:18];
...
{
    mum.hidden = NO;
    NSDictionary *aParameterDic = [NSDictionary dictionaryWithObjectsAndKeys:userData.userId,@"cid",userData.userAccount,@"mobile",userData.userPassword,@"pwd",@"list",@"action",@"",@"pagenum",@"",@"employ",@"",@"mname",@"",@"sdate",@"",@"edate", nil];
    [parameterDic setDictionary:aParameterDic];
    [currentRequestContent currentRequestWithURL:_PAIZHAO_INTERFACE_ andParameter:parameterDic];
}
-(void)ransmitRequestWithDic:(NSDictionary*)aDic//发送请求
{
    mum.hidden = NO;
...
-(void)reportData//上报
{
    ...
    photographUploadingReportVC.delegate = self;
...
{
    [self touchesBegan:nil withEvent:nil];
    [parameterDic setObject:queryTextField1.text forKey:@"employ"];
    [parameterDic setObject:queryTextField2.text forKey:@"mname"];
...
-(void)refreshSucceedWithContentDictionary:(NSDictionary*)aContentDic
{
    ...
    if ([flagStr isEqualToString:@"success"]) {
        ...
        if (listArray.count) {
            [cellViewArray setArray:[AKFastCallView photoRecordCellViewWithArray:listArray]];
