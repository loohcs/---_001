//
//  AKProductQueryContentViewController.m
//  农化通
//
...
@interface AKProductQueryContentViewController ()
...
@implementation AKProductQueryContentViewController
...
- (void)viewDidLoad
{
    ...
    UILabel *topItemLabel = [AKFastLabel labelWithFrame:CGRectMake(0, 0, 180, 30) andText:@"产品查询" andtextAlignment:UITextAlignmentCenter andFont:18];
...
//    NSLog(@"%@",aContentDic);
    ...
    if ([flagStr isEqualToString:@"success"]) {
        ...
        if (listArray.count) {
            [cellViewArray setArray:[AKFastCallView productQueryCellViewWithArray:listArray]];
