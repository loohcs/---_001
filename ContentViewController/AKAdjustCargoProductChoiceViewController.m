//
//  AKAdjustCargoProductChoiceViewController.m
//  农化通
//
...
@interface AKAdjustCargoProductChoiceViewController ()
...
@implementation AKAdjustCargoProductChoiceViewController
@synthesize delegate;
...
- (void)addSelectView
{
    ...
    UIView *minSelectView = [AKFastView viewWithWithFrame:CGRectMake(20, 40, 280, 220) andBackgroundColor:[UIColor blackColor]];
    ...
    topLabel.textColor = [UIColor whiteColor];
    UILabel *selectLabel1 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 50, _FOUR_WIDTH_, _LINE_HEIGHT_) andText:@"调出单价：" andtextAlignment:UITextAlignmentLeft andFont:_QUERY_LABEL_FONT_];
    selectLabel1.textColor = [UIColor whiteColor];
    UILabel *selectLabel2 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 65+_LINE_HEIGHT_, _FOUR_WIDTH_, _LINE_HEIGHT_) andText:@"调入单价：" andtextAlignment:UITextAlignmentLeft andFont:_QUERY_LABEL_FONT_];
    selectLabel2.textColor = [UIColor whiteColor];
    UILabel *selectLabel3 = [AKFastLabel labelWithFrame:CGRectMake(_START_INTERVAL_, 80+2*_LINE_HEIGHT_, _FOUR_WIDTH_, _LINE_HEIGHT_) andText:@"调货数量："andtextAlignment:UITextAlignmentLeft andFont:_QUERY_LABEL_FONT_];
    selectLabel3.textColor = [UIColor whiteColor];
    ...
    selectTextField2.text = @"1";
    selectTextField3 = [AKFastTextField textFieldWithFrame:CGRectMake(95, 130, 150, 30) andBackgroundColor:[UIColor whiteColor] andBorderStyle:UITextBorderStyleBezel andKeyboardType:UIKeyboardTypeNumbersAndPunctuation andFont:15.f];
    selectTextField3.tag = 503;
    selectTextField3.delegate = self;
    selectTextField3.text = @"1";
    UIButton *selectBtn = [AKFastButton buttonWithType:UIButtonTypeCustom andFrame:CGRectMake(160, 95+3*_LINE_HEIGHT_, 80, 30) andNormalTitle:@"确定" andBackgroundImage:[UIImage imageNamed:@"button_60.png"] andTouchUpTarget:self andTouchUpAction:@selector(selectBegin)];
    [selectBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    UIButton *cancelBtn = [AKFastButton buttonWithType:UIButtonTypeCustom andFrame:CGRectMake(30, 95+3*_LINE_HEIGHT_, 80, 30) andNormalTitle:@"取消" andBackgroundImage:[UIImage imageNamed:@"button_60.png"] andTouchUpTarget:self andTouchUpAction:@selector(selectCancel)];
    [cancelBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
...
{
    [self touchesBegan:nil withEvent:nil];
    [popDic setObject:selectTextField1.text forKey:@"oprice"];
    [popDic setObject:selectTextField2.text forKey:@"iprice"];
    [popDic setObject:selectTextField3.text forKey:@"pnum"];
    [self.navigationController popViewControllerAnimated:NO];
    [delegate adjustCargoproductChoiceSucceedPopWithDictionary:popDic];
    selectView.hidden = YES;
}
#pragma - 连接代理
//请求成功
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [selectTextField3 resignFirstResponder];
